...
import importedImage from "../../../assets/Images/small.jpg"; // Update this path to the location of your image

const LeadPipelineComponent = () => {
  return (
    <div className="w-full mx-auto p-8 min-h-[30vh] bg-white rounded-lg  overflow-auto">
      <h1 className="text-[40px] font-bold text-center mb-4">
        Create Your Lead Pipeline Using Infinite
        <br />
        <span className="text-purple-600">Auto-Rotating</span> Email Accounts
      </h1>
      <br />
      <br />
      <br />
      <div className="flex flex-col md:flex-row items-start justify-center">
        <div className="w-full md:w-1/2 mb-4 md:mb-0 flex items-center justify-center">
          <div className="absolute right-[30px] w-[700px] h-[400px] bg-gray-200 rounded-3xl overflow-hidden relative">
            <img
              src={importedImage}
              alt="Description of the image"
              className="w-full h-full object-cover"
            />
            <button className="absolute bottom-0 right-0 bg-custom-blue h-[50px] text-white px-6 py-3 rounded-full text-sm font-semibold hover:bg-purple-700 transition-colors">
              Stop Landing In Spam
            </button>
          </div>
        </div>
        <div className="w-full md:w-1/2 relative right-[90px] top-[9px]">
...
export default LeadPipelineComponent;